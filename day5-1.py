class crates():
        ...
        def moveCrate(self, numberOfCrates, fromColumn, toColumn):
                for i in range(numberOfCrates):
                        #Popper siste kasse i fra-kolonne og legger den til i til-kolonne
                        if len(self.__listOfCrateColumns[fromColumn]) > 0:
                                self.__listOfCrateColumns[toColumn].append(self.__listOfCrateColumns[fromColumn].pop())
                        else:
                                break
